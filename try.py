...
st.markdown("Create unique story continuations using GPT-2. Enter a beginning, name your characters, and select a genre!")

# Character name input
character_names = st.text_input("Enter main character name(s), separated by commas", placeholder="Alice, Bob")
